...
- **Source:** [Full TMDB Movies Dataset 2024 (1M Movies) — Kaggle](https://www.kaggle.com/)
- **Sample:** Film rilis tahun 2010–2024
...
|---|---|---|---|
| Total Profit | 195.6 M (unit dataset) | 35.4 M | ↓ ~82% |
| Total Budget | 89.2 M | 23.8 M | ↓ ~73% |
| Total Revenue | 284.9 M | 59.2 M | ↓ ~79% |
| Total Film | 2.923 | 519 | ↓ ~82% |
| Average ROI | 3,45x | 2,88x | ↓ |
...
- **Pergeseran preferensi genre:**
  - **Drama** tetap dominan namun kehilangan pangsa pasar (dari ±30% ke ±26%)
...
3. **Fokus pada genre bermargin tinggi & berpotensi viral** seperti Horror dan Mystery — biaya produksi rendah, potensi profit tinggi jika dikemas dengan kampanye pemasaran yang tepat.
...
`Microsoft Excel` — data cleaning, pivot table, dan dashboard interaktif

## 📁 Repository Contents

- `Project_Portfolio_-_Dashboard_-_Fariz_Agyan.xlsb` — Dashboard interaktif berisi KPI dan 4 chart analisis (tren produksi, revenue, dan pergeseran genre)
- `Project_Portfolio_-_PPT_-_Fariz_Agyan.pptx` — Slide presentasi hasil analisis dan rekomendasi
